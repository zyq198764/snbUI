...
class SNB_login_page(Snb_LoginPageUI):
    ...
    def get_login_input_phone_Loc_page(self):
        ...
        :return:
        """
        return self.get_login_input_phone_Loc().send_keys('13512341234')

    def get_login_input_error_phone_Loc_page(self):
        """
            输入错误的手机号
        :return:
        """
        return self.get_login_input_phone_Loc().send_keys('11111111111')
    ...
    def get_login_verficode_Loc_page(self):
        ...
        :return:
        """
        return self.get_login_reverficode_Loc().send_keys('123456')

    def get_login_error_verficode_Loc_page(self):
        """
           输入错误短信验证码
        :return:
        """
        return self.get_login_verficode_Loc().send_keys('111111')

    def get_login_error_verficode_text_loc_page(self):
        """
           输入错误短信验证码的提示语
        :return:
        """
        return self.get_login_error_verficode_Loc().text

    def get_login_verficode_click_Loc_page(self):
        """
           点击重新发送按钮
        :return:
        """
        return self.get_login_verficode_click_Loc().click()
    ...
    def get_login_input_passwd_Loc_page(self):
        ...
        :return:
        """
        return self.get_login_input_passwd_Loc().send_keys('q1234567890')
    ...
    def get_login_input_passwd_icon1_Loc_page(self):
        ...
        :return:
        """
        return self.get_login_input_passwd_icon1_Loc().click()
    ...
    def  get_login_reinput_passwd_Loc_page(self):
        ...
        :return:
        """
        return self.get_login_reinput_passwd_Loc().send_keys("q1234567890")

    def  get_login_input_error_phone_text_Loc_page(self):
        """
            输入错误的手机号，提示，请输入正确的手机号码
        :return:
        """
        return self.get_login_input_error_phone_Loc().text