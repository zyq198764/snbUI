...
class SNB_bank_card_page(Snb_Bank_Card_PageUI):
    ...
    def get_add_bank_card_name_clickLoc_page(self):
        """
            获取添加银行卡页面持卡人文本
        :return:
        """
        return self.get_add_bank_card_name_Loc().click()
    ...
    def get_add_bank_card_vercode_click_Loc_page(self):
        """
            输入短信验证码
        :return:
        """
        return self.get_add_bank_card_vercode_Loc().click()
