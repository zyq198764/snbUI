...
class Test_SNB_Regression(AppTest):
    ...
    """def test_02_login(self):
        ...
        try:
            ...
            self.log.info("输入粗我的短信验证码的提示语是：%s"%error_vercode)
            time.sleep(2)
    ...
    def test_05_buy_now(self):
        ...
        try:
            ...
            time.sleep(1)
            Snb_buy_now_po.get_set_passwd_03Loc_page()
            time.sleep(1)
            ...
            time.sleep(2)
            self.log.info("已经输入错误的支付密码123457")
            ...
            Snb_buy_now_po.get_set_passwd_05Loc_page()
            time.sleep(1)
            Snb_buy_now_po.get_set_passwd_06Loc_page()
            time.sleep(2)
    ...
    def test_07_redeem(self):
       ...
       try:
            ...
            time.sleep(1)
            Snb_Redeem_po.get_set_passwd_03Loc_page()
            time.sleep(1)
            ...
            Snb_Redeem_po.get_set_passwd_05Loc_page()
            time.sleep(1)
            Snb_Redeem_po.get_set_passwd_06Loc_page()
            time.sleep(2)
            self.log.info("已经输入支付密码123456")
    ...
    def test_08_hold(self):
        ...
        try:
            ...
            time.sleep(1)
            Snb_set_password_po.get_set_passwd_03Loc_page()
            time.sleep(1)
            Snb_set_password_po.get_set_passwd_04Loc_page()
            time.sleep(1)
            Snb_set_password_po.get_set_passwd_05Loc_page()
            time.sleep(1)
            Snb_set_password_po.get_set_passwd_06Loc_page()
            time.sleep(2)
